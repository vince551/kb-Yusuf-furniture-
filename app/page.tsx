...
const images={
  hero:local('0eddd20f8458375dadf3b78c39c675a2.jpg'),
  living:local('15d900d80767c34c4396197a2a935293.jpg'),
  dining:local('2c050b2da01e5ff74969aada972360db.jpg'),
  bedroom:local('6def6def9e3064a1e6c7e1513df7ddb9.jpg'),
  office:local('0eddd20f8458375dadf3b78c39c675a2.jpg'),
  lounge:local('15d900d80767c34c4396197a2a935293.jpg'),
  detail:local('2c050b2da01e5ff74969aada972360db.jpg'),
  diningAlt:local('2c050b2da01e5ff74969aada972360db.jpg'),
  bedroomAlt:local('6def6def9e3064a1e6c7e1513df7ddb9.jpg')
};
const products=[
...
<section className="hero-premium">
  <img src={images.hero} alt="Tovi Furniture interior collection"/><div className="hero-shade"/>
  <div className="hero-content"><div className="hero-meta"><p>Collection No. 01 / 2026</p><p>Nairobi<br/>Kenya</p></div>
...
<section className="inspiration-section"><div className="section-head"><div><p className="eyebrow">02 — The inspiration edit</p><h2 className="display">Cute, considered, collected.</h2></div><a className="muted-link" href="https://www.pinterest.com/bocadolobo/luxury-furniture/" target="_blank" rel="noreferrer">Open inspiration board ↗</a></div><div className="masonry">{inspiration.map(([title,img],i)=><Link href="/journal" className={`inspiration-card insp-${i+1}`} key={title}><img src={img} alt={title}/><div><span>{title}</span><ArrowUpRight size={14}/></div></Link>)}</div><p className="image-note">Tovi Furniture uses your repository photography throughout the storefront.</p></section>
