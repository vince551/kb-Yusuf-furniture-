...
const local = (file:string) => `${base}/${file}`;
const images={
  hero:local('04edeef389d9974a476fbe638aa6f642.jpg'),
  living:local('0865349b2c2c7fc9275ff3ec59bad7db.jpg'),
  dining:local('14128ff6ee4ec64f94d59a78594766fc.jpg'),
  bedroom:local('2e7e7bfa47fb1397795f094786136240.jpg'),
  office:local('4499a012dbc42d9e48628f60a2012f99.jpg'),
  lounge:local('50ddd56bf3928c38a2f47e5c1450f143.jpg'),
  detail:local('a700dae95f66818fac58c8302b07bda2.jpg'),
  diningAlt:local('ab9d0ed8cb648ad2966a201c3cfd35c3.jpg'),
  bedroomAlt:local('811c3544409a04d9e41ab37844bcf6da.jpg')
};
const products=[
...
<ScrollProgress/><PremiumPolish/>
<div className="marquee"><span>TOVI FURNITURE · NAIROBI · PRIVATE INTERIOR CONSULTATIONS · COMPLIMENTARY DELIVERY OVER KSh 20,000 · TOVI FURNITURE · NAIROBI · PRIVATE INTERIOR CONSULTATIONS · COMPLIMENTARY DELIVERY OVER KSh 20,000 · </span></div>
<header className="site-header">
  <Link href="/" className="brand"><span>TOVI FURNITURE</span><small>Furniture · Interiors · Objects</small></Link>
...
<section className="statement"><div className="statement-word display">TOVI</div><div className="statement-grid"><div><p className="eyebrow">04 — The Tovi Furniture approach</p><h2 className="display">Designed to be lived in.<br/><i>Not just looked at.</i></h2></div><div><p>Natural oak. Linen. Bouclé. Stone. Brushed metal. We select materials for how they feel at first touch — and how beautifully they wear over time.</p><div className="gold-line"/><small>Material · Form · Craft · Place</small></div></div></section>
<section className="ai-banner"><img src={images.lounge} alt="Tovi Furniture AI styling consultation"/><div className="ai-overlay"/><div className="ai-content"><Sparkles size={22}/><p className="eyebrow">Tovi AI Concierge</p><h2 className="display">Tell us how you want<br/><i>your home to feel.</i></h2><p>“Warm, minimal, a little dramatic — and I have KSh 150,000.” Start there. We'll do the rest.</p><Link href="/concierge" className="btn-gold">Meet your concierge <ArrowUpRight size={14}/></Link></div></section>
...
<footer><div className="footer-grid"><div><span className="footer-brand display">TOVI FURNITURE</span><p>Furniture, interiors and intelligent styling for beautiful living.</p></div><div><b>Explore</b><Link href="/shop">Collection</Link><Link href="/spaces">Spaces</Link><Link href="/journal">Journal</Link></div><div><b>Client care</b><Link href="/contact">Contact</Link><Link href="/account">Account</Link><Link href="/cart">Shopping bag</Link></div><div><b>Nairobi</b><p>Private appointments<br/>Kenya</p></div></div><div className="copyright">© 2026 Tovi Furniture · Crafted for beautiful living</div></footer>
</main>}
